  ...
  return (
    <div className='w-full flex flex-col justify-center bg-white p-6 rounded-t-3xl'>
      ...
      <div className='flex flex-col items-center justify-center gap-2.5 mt-10'>
        <h1 className='text-2xl text-gray-800 font-catamaran font-bold'>OTP Verification</h1>
        <div className='px-3 flex flex-col items-center justify-center'>
          <p className='text-base text-center text-gray-600 font-noto-sans font-medium'>Please enter the verification code sent 
          to ********@gmail.com</p>
        </div>
      </div>
      {/* Form */}
